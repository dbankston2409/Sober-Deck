...
const growthTracks = {
  low: {
    ...
    icon: "🔹",
    data: [
      { year: "Year 1", licenses: 1000, monthlyRevenue: 79000, annualRevenue: 948000 },
      { year: "Year 2", licenses: 2150, monthlyRevenue: 169850, annualRevenue: 2038200 },
      { year: "Year 3", licenses: 4622, monthlyRevenue: 365178, annualRevenue: 4382130 }
    ],
    salesNeeded: [
      {
        year: "Year 1",
        data: [
          { avgLicenses: 30, totalSales: 34, monthlySales: 3 },
          { avgLicenses: 60, totalSales: 17, monthlySales: 2 },
          { avgLicenses: 90, totalSales: 12, monthlySales: 1 }
        ]
      },
      {
        year: "Year 2",
        data: [
          { avgLicenses: 30, totalSales: 72, monthlySales: 6 },
          { avgLicenses: 60, totalSales: 36, monthlySales: 3 },
          { avgLicenses: 90, totalSales: 24, monthlySales: 2 }
        ]
      },
      {
        year: "Year 3",
        data: [
          { avgLicenses: 30, totalSales: 155, monthlySales: 13 },
          { avgLicenses: 60, totalSales: 78, monthlySales: 7 },
          { avgLicenses: 90, totalSales: 52, monthlySales: 5 }
        ]
      }
    ]
  },
  medium: {
    ...
    icon: "🔸",
    data: [
      { year: "Year 1", licenses: 2000, monthlyRevenue: 158000, annualRevenue: 1896000 },
      { year: "Year 2", licenses: 4300, monthlyRevenue: 339700, annualRevenue: 4076400 },
      { year: "Year 3", licenses: 9245, monthlyRevenue: 730355, annualRevenue: 8764260 }
    ],
    salesNeeded: [
      {
        year: "Year 1",
      ...
      },
      {
        year: "Year 3",
        data: [
          { avgLicenses: 30, totalSales: 309, monthlySales: 26 },
          { avgLicenses: 60, totalSales: 155, monthlySales: 13 },
          { avgLicenses: 90, totalSales: 103, monthlySales: 9 }
        ]
      }
    ]
  },
  high: {
    ...
    icon: "🔺",
    data: [
      { year: "Year 1", licenses: 3000, monthlyRevenue: 237000, annualRevenue: 2844000 },
      { year: "Year 2", licenses: 6450, monthlyRevenue: 509550, annualRevenue: 6114600 },
      { year: "Year 3", licenses: 13867, monthlyRevenue: 1095493, annualRevenue: 13145916 }
    ],
    salesNeeded: [
      {
        year: "Year 1",
        data: [
          { avgLicenses: 30, totalSales: 100, monthlySales: 9 },
          { avgLicenses: 60, totalSales: 50, monthlySales: 5 },
          { avgLicenses: 90, totalSales: 34, monthlySales: 3 }
        ]
      },
      {
        year: "Year 2",
        data: [
          { avgLicenses: 30, totalSales: 215, monthlySales: 18 },
          { avgLicenses: 60, totalSales: 108, monthlySales: 9 },
          { avgLicenses: 90, totalSales: 72, monthlySales: 6 }
        ]
      },
      {
        year: "Year 3",
        data: [
          { avgLicenses: 30, totalSales: 463, monthlySales: 39 },
          { avgLicenses: 60, totalSales: 232, monthlySales: 20 },
          { avgLicenses: 90, totalSales: 155, monthlySales: 13 }
        ]
      }
    ]
  }
...
export default function StandardTierSection() {
    ...
    <section className="section-height section-padding flex flex-col justify-center">
      <div className="max-w-7xl mx-auto w-full space-y-12">
        ...
        >
          ...
          >
            Sober Logic – Standard License Tier Projections ($79/month)
          </h2>
          <p 
            className="text-xl"
